...
curl -s -X POST "${BASE_URL}/publish/documents/PAS-L1-GOV-PRC-001/checklists" -H "x-api-key: ${API_KEY}" -H "Content-Type: application/json" -d '{"version": "v2.0.0","entries": [{"type": "Creator","id": "CHK-CR-2025-001","status": "Aprobada","date": "2025-03-10"},{"type": "Reviewer","id": "CHK-RV-2025-002","status": "Aprobada","date": "2025-03-11"},{"type": "QAC","id": "CHK-QA-2025-004","status": "Aprobada","date": "2025-03-12"},{"type": "Approver","id": "CHK-AP-2025-005","status": "Aprobada","date": "2025-03-12"}]}' | jq
echo ""
echo "=========================================="
echo ""
...
curl -s -X POST "${BASE_URL}/publish/documents/PAS-L1-GOV-PRC-001/audit-pack" -H "x-api-key: ${API_KEY}" -H "Content-Type: application/json" -d '{"version":"v2.0.0"}' | jq
